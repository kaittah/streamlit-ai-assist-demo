...
from src.streamlit_ai_assist.interface import main

import streamlit as st
import plotly.graph_objects as go
import plotly.express as px

main.DataAnalystChat(graphing_file_path="graphing_tastybytes.py",
                     graphing_import_path="graphing_tastybytes",
                     database_name="tastybytes_snowflake",
                     general_description="menu of a food truck").run()
